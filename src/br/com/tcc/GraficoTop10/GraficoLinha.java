...
public class GraficoLinha extends JFrame{
    ...
    public GraficoLinha() throws SQLException{
// 
        ...
        JFreeChart chart = ChartFactory.createLineChart("10 Mais vendidos", "Produtos", "Vendidos", dataset, PlotOrientation.VERTICAL,false,true,true);
