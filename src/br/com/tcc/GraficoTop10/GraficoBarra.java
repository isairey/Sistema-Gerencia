...
public class GraficoBarra extends JFrame{
    ...
    public GraficoBarra() throws SQLException{
// 
        ...
        JFreeChart chart = ChartFactory.createBarChart("10 Mais vendidos", "Produtos", "Vendidos", dataset, PlotOrientation.VERTICAL,false,true,true);
